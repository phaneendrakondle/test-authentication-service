...
dependencies {
    ...
    implementation ("org.springframework.boot:spring-boot-starter-web:2.7.18") // Updated for CVE-2025-24813 fix
    
    // Explicitly override Tomcat version to fix CVE-2025-24813
    // Using Tomcat 9.0.99+ which includes the fix for CVE-2025-24813
